...
SECRET_KEY = 'django-insecure-h7d3w#$%^&*()_+asdfghjkl;zxcvbnm,./'
...
DEFAULT_FROM_EMAIL = 'noreply@loanapplication.com'

# DocuSign settings (placeholder - would be configured in production)
...
DOCUSIGN_WEBHOOK_SECRET = 'placeholder-webhook-secret'
